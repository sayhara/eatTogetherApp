...
class GatheringCreateScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GatheringCreateScreen> createState() =>
      _GatheringCreateScreenState();
}
...
class _GatheringCreateScreenState extends ConsumerState<GatheringCreateScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        context.replace('/gathering/${res.data['data']['id']}');
      }
    } catch (e) {
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading
                    ...
                    : const Text('모임 만들기', style: TextStyle(fontSize: 18)),
              ),
            ),
          ],
        ),
